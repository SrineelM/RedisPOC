...
public class AuthController {
    ...
    public AuthController(JwtService jwtService, PasswordEncoder passwordEncoder, AuditLogger auditLogger, StringRedisTemplate stringRedisTemplate) {
    ...
    private String failureKey(String user) { return "auth:fail:user:"+user; }
    private String lockKey(String user) { return "auth:lock:user:"+user; }
